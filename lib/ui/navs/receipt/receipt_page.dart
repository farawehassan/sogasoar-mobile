...
class _ReceiptState extends State<Receipt> {
  ...
  static const String _companyName = "Sogasoar Ventures";

  /// Constant holding the company's name
  static const String _companyDetails = "General Distributors / Contractors Suppliers";

  /// Constant holding the company's address
  static const String _address = "27, Ifelodu Street off Odunsi, Shomolu Bariga Lagos.";

  /// Constant holding the company's phone number
  static const String _phoneNumber = "08068917588, 09057890850";

  /// Constant holding the company's email
  static const String _email = "help@sogasoarventures.com";
                            ...
                            child: Container(
                              ...
                              child: TypeAheadFormField(
                                validator: (value) {
                                  if (value.isEmpty) {
                                    setState(() {
                                      if(_animatedHeight == 289){
                                        _animatedHeight = 311;
                                      }
                                      else if(_animatedHeight == 311){
                                        _animatedHeight = 332;
                                      }
                                    });
                                    return 'Select name';
                                  ...
                                  setState(() {
                                    if(_animatedHeight == 311){
                                      _animatedHeight = 311;
                                    }
                                    else if(_animatedHeight == 332){
                                      _animatedHeight = 332;
                                    } else {
                                      _animatedHeight = 289;
                                    }
