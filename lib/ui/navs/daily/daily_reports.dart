import 'package:sogasoarventures/bloc/daily_report_chart.dart';
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    SizedBox(height: 8.0,),
                    titleText('Outstanding Payment: ${Constants.money(_outstandingPayment)}'),
                    SizedBox(height: 8.0,),
                    titleText('Available Cash: ${Constants.money(_availableCash - _outstandingPayment)}'),
                    SizedBox(height: 8.0,),
                    titleText('Total Cash: ${Constants.money(_availableCash + _totalTransfer)}'),
                    SizedBox(height: 8.0,),
                    _user == 'Admin' ? titleText('Profit made: ${Constants.money(_totalProfitMade)}') : Container(),
                  ],
                ),
              ),
            ],
