...
import 'package:sogasoarventures/ui/navs/product_history.dart';
                    ...
                    children: <Widget>[
                      ...
                      Container(
                        ...
                        child: TextFormField(
                          ...
                          decoration:
                          kAddProductDecoration.copyWith(hintText: "Product name"),
                        ),
                      ),
                      Container(
                        width: 150.0,
  ...
  Widget _buildInnerTopWidget(String productName) {
    return Container(
      ...
      child: Row(
        ...
        children: [
          IconButton(
            icon: Icon(Icons.history, color: Color(0xFF061D5C)),
            onPressed: (){
              String id;
        ...
        child: Card(
          ...
          child: Padding(
            ...
            child: Row(
              ...
              children: <Widget>[
                IconButton(
                  icon: Icon(Icons.expand_less, color: Color(0xFF061D5C)),
                  onPressed: () {
                    SimpleFoldingCellState foldingCellState = context.findAncestorStateOfType<SimpleFoldingCellState>();
                    foldingCellState?.toggleFold();
                  },
