...
import 'package:sogasoarventures/bloc/select_suggestions.dart';
import 'package:sogasoarventures/database/user_db_helper.dart';
import 'package:sogasoarventures/model/productDB.dart';
import 'package:sogasoarventures/styles/theme.dart' as Them;
import 'package:sogasoarventures/ui/navs/receipt/receipt_page.dart';
                ...
                children: <Widget>[
                  GestureDetector(
                    ...
                    child: UserAccountsDrawerHeader(
                      ...
                      accountName: Text("Sogasoar Ventures"),
                      accountEmail: Text("help@sogasoarventures.com"),
                  ...
                  ListTile(
                    leading: Icon(Icons.create, color: Color(0xFF061D5C)),
                  ...
                  ListTile(
                    leading: Icon(Icons.book, color: Color(0xFF061D5C)),
                    title: Text('Products'),
                    onTap: (){
                  ...
                  ListTile(
                    leading: Icon(Icons.assignment_returned, color: Color(0xFF061D5C)),
                  ...
                  ListTile(
                    leading: Icon(Icons.note, color: Color(0xFF061D5C)),
                  ...
                  ListTile(
                    leading: Icon(Icons.account_circle, color: Color(0xFF061D5C)),
                  ...
                  ListTile(
                    leading: Icon(Icons.settings, color: Color(0xFF061D5C)),
                    trailing: Switch(
                      activeColor: Color(0xFF061D5C),
                      value: _enabled,
              ...
              children: <Widget>[
                ...
                FlatButton(
                  onPressed: (){
                    showAboutDialog(
                      context: context,
                      applicationName: 'Sogasoar Ventures',
                      applicationIcon: AnimatedContainer(
                        ...
                        child: Image(
                          image: AssetImage('Assets/images/sogasoar_logo.png'),
                        ),
                      ),
